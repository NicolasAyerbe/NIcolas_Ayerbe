...
function definirJornada(horaEvento) {
    ...
    let horaLlegada1 = new Date(2022, 12, 11, 12, 12, 0);
    ...
    let horaLlegada2 = new Date(2022, 2, 12, 10, 15, 0);
    let horaSalida2Str = definirJornada(horaSalida2);
    let horaLlegada2Str = definirJornada(horaLlegada2);

    let horaSalida3 = new Date(2022, 2, 12, 12, 40, 0);
    let horaLlegada3 = new Date(2022, 2, 12, 13, 50, 0);
    let horaSalida3Str = definirJornada(horaSalida3);
    let horaLlegada3Str = definirJornada(horaLlegada3);

    let horaSalida4 = new Date(2022, 11, 12, 12, 10, 0);
    let horaLlegada4 = new Date(2022, 11, 12, 13, 50, 0);
